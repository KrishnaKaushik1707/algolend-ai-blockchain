...
const LoanCard = ({
  ...
  if (status === "Active")
    statusBadge = (
      <span className="badge badge-active rounded-pill px-3 py-2 fw-semibold">
        Active
      </span>
    );
  else if (status === "Pending")
    statusBadge = (
      <span className="badge badge-pending rounded-pill px-3 py-2 fw-semibold">
        Pending
      </span>
    );
      ...
      <Card.Body className="p-4">
        {isDashboard && (
          <div className="d-flex justify-content-between align-items-center mb-3">
            <span className="text-body-secondary fw-semibold fs-6">
              Loan #{id}
            </span>
            {statusBadge}
          </div>
        ...
        {isMarketplace && (
          <div className="d-flex align-items-center mb-3">
            <div className="bg-primary bg-opacity-10 text-primary rounded-circle p-2 me-3">
              <span
                className="fw-bold fs-5 d-block text-center"
            ...
            <div>
              ...
              <small className="text-body-secondary">Seeking Loan</small>
            </div>
          </div>
        )}
        ...
        <div className="d-flex justify-content-between mb-4 bg-body-tertiary p-3 rounded-3">
          <div className="d-flex flex-column">
            <span className="text-body-secondary small mb-1 d-flex align-items-center">
              <Percent size={14} className="me-1" /> Interest
            </span>
            <span className="fw-semibold">{interestRate}% APR</span>
          </div>
          <div className="border-start"></div>
          <div className="d-flex flex-column text-end">
            <span className="text-body-secondary small mb-1 d-flex align-items-center justify-content-end">
              <CalendarDays size={14} className="me-1" /> Term
            </span>
